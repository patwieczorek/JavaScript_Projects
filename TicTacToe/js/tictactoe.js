...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'O') {
            ...
            disableClick();
            //This function waits 1 second before the omputer places an image and enables click.
...
function checkWinConditions() {
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //true is returned and our else if condition executes the draLine() function.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        //This method clears content from the last loop interaction. 
        c.clearRect (0, 0, 608, 608);
        //This method starts a new path.
        c.beginPath();
        //This method moves us to a starting point in our line. 
        c.moveTo(x1, y1);
        //This indicates the end of point in our line.
        c.lineTo(x, y);
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            if (y < y2) { y += 10; }
            //This conditionis similar to the one above.
